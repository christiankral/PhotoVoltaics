...
equation
  ...
  connect(mpTracker.power, powerSensor.power) annotation (Line(points={{-12,-80},
          {-24,-80},{-40,-80},{-40,49}},                                                                        color={0,0,127}));
  annotation (
    defaultComponentName = "converter",Icon(coordinateSystem(preserveAspectRatio=false), graphics={                                                                                                                                                                       Text(extent={{-100,40},{-40,-40}},      lineColor = {0, 0, 255}, textString = "="),                                                                                                                                                                                                        Text(extent={{-80,90},{20,50}},      lineColor={0,0,255},     pattern=LinePattern.Dash,   fillColor={0,0,255},
