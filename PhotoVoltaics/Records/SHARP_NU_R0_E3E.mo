...
record SHARP_NU_R0_E3E "SHARP NU monocrystalline SI cell 170W"
  extends PhotoVoltaics.Records.ModuleData(final moduleName = "SHARP_NU_R0_E3E", final TRef = 298.15, final irradianceRef = 1000, final VocRef = 29.4, final IscRef = 8.37, final VmpRef = 22.4, final ImpRef = 7.6, final alphaIsc = +0.00053, final alphaVoc = -0.00350, final ns = 48, final nb = 3);
  annotation (
